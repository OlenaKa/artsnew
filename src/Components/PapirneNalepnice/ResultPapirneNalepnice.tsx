...
import { PriceDetails } from "./formulaHelperPapirneNalepnice";

export default function ResultPapirneNalepnice(params: PriceDetails) {
  useEffect(() => {
      ...
      <Box>
        ...
        <Table>
          ...
          <TableBody>
            {params.moq && (
              <TableRow>
                <TableCell>Minimalna količina za 200 din:</TableCell>
