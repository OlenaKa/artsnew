...
export default function Footer({ categories }: FooterProps): JSX.Element {
  return (
      ...
      <Paper>
        ...
        <List className="socials">
          <ListItem>
            <Link
              className="socials"
              href="https://www.facebook.com/arts.designdoo"
          ...
          <ListItem>
            <Link
              className="socials"
              href="https://www.instagram.com/arts_design_belgrade/"
              rel="noopener noreferrer"
              target="_blank"
            >
              <InstagramIcon />
          ...
          <ListItem>
            <Link
              className="socials"
              href="https://www.youtube.com/channel/UC9QvsvynPKgh8g5LZsm8Qqw"
              rel="noopener noreferrer"
              target="_blank"
            >
              <YouTubeIcon />
